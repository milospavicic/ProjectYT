...
function fillPage(search){
	...
	var userDiv = $('.row');
	userDiv.empty();
	$.get('GetUsersServlet',{"search":search,"input":input},function(data){
...
function saveEditUser(){
	...
	$.post('ChannelServlet',{"status":"edit","channelName":tempChannelName,"firstName":firstName,"lastName":lastName,"password":password,"email":email,"channelDescription":channelDescription,"userType":userType,"profileUrl":profileUrl,"lol":lol},function(data){
		if(lol==true)
			editUploadPicture();
		location.reload();
	});
...
function deleteUser(){
	$.post('ChannelServlet',{"status":"delete","channelName":tempChannelName},function(data){location.reload();});
}
function blockUser(){
	$.post('ChannelServlet',{"status":"block","channelName":tempChannelName},function(data){location.reload();});
}
function unblockUser(){
	$.post('ChannelServlet',{"status":"unblock","channelName":tempChannelName},function(data){location.reload();});
}
function errorPage(){
