...
public class VideoServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		case "newVideo":
			...
			int newId = VideoDAO.getVideoId();
			Date newDate = new Date();
			String newDateForBase = UserDAO.dateToStringForWrite(newDate);
			Video newVideo = new Video(newId, newVideoUrl, newPicUrl, newTitle, newDesc, null, false, false, false, 0, 0, 0, newDateForBase, loggedInUser, false);
			if(newVisib==1) 
